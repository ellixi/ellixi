...
export default function Home() {
  ...
  const signer: Signer = new ethers.Wallet("f6898e1d168259732f665c00a19b35ca977f12655edd9e4a7b4744fc2bc770a1");
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div>
                    <>
                      ...
                      {loading ? 'loading...' : `${(+utils.formatEther(balance)).toFixed(4)} ETH`}
                    </>
                  </div>
                </div>
              </div>
